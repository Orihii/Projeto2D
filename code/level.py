...
class Level:
    ...
    def run(self):
        ...
        while running:
            ...
            #  Desenha fundo, inimigos e player
            ...
            enemies_text = self.font.render(f"Inimigos: {len(self.enemies)}", True, WHITE)
            self.window.blit(enemies_text, (10, 50))
            
            controls_text = self.font.render("Mouse: Mirar e Disparar | WASD: Mover", True, WHITE)
            ...
            if self.game_over:
                ...
                final_score_text = self.font.render(f"Score Final: {self.score}", True, WHITE)
